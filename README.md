...
- **TCP Client/Server** - Test and debug TCP connections.
...
1. Open **ZConnect** after installation.
2. Select the protocol (TCP/UDP/Serial) from the tabs.
3. Configure the connection parameters (IP, port, baud rate, parity, etc.).
...
- Reporting issues via [GitHub Issues](https://github.com/zhiyuan6589/ZConnect/issues)
