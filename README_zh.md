...
查看英文版本，请点击 [README.md](README.md)
...
1. 安装完成后打开 ZConnect。
2. 从标签页中选择协议（TCP/UDP/串口）。
3. 配置连接参数（IP、端口、波特率、校验位等）。
4. 打开连接开始收发数据。
5. 在主面板中监控接收到的消息。
...
- 通过 [GitHub Issues](https://github.com/zhiyuan6589/ZConnect/issues) 报告问题
